...
for i=offs:(lengy)
    ...
    correlationResult = normxcorr2(smoothedReference,red_channel);
...
for i=200:lengy
    ...
    % Display the location of the peak correlation
    hold on;
    %plot(centerpos(i,2)-800, centerpos(i,1)-800, 'b+', 'MarkerSize', 10);
    %[centerpos(i,2)-800, centerpos(i,1)-800]
    [real_coord_x, real_coord_y] = ginput(1)
    hold off;
...
%% INTERPOLATE PIV FIELDS IN BALL'S SYSTEM OF REFERENCE
